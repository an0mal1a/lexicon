...
```env
LEXICON_DATASET_PATH=../lxdb/datasets/generated/es/dictionary.lxdb
...
lxdb dictionary build es \
  --output datasets/generated/es/dictionary.lxdb
```

Then configure:

```env
LEXICON_DATASET_PATH=/absolute/path/to/dictionary.lxdb
```
